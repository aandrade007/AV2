    ...
    return (
        <div className="max-w-4xl mx-auto animate-fade-in">
            ...
            <header className="mb-8 flex justify-between items-end print:hidden">
                <div>
                    <h1 className="text-3xl font-bold text-white">Relatório Final</h1>
                    <p className="text-slate-100 mt-2">Gere e exporte o documento oficial consolidado de produção.</p>
                </div>
                <button 
                    onClick={handleImprimir}
                    className="flex items-center gap-2 text-xl text-white p-3 font-bold bg-gray-500/70 rounded-2xl hover:scale-105 hover:bg-sky-600 duration-200 shadow-lg"
                >
                    Exportar PDF
                </button>
            </header>

            <div className="bg-white p-12 rounded-xl shadow-md border border-slate-200 text-slate-800 print:shadow-none print:border-none print:p-0">
                ...
                <div className="mb-8">
                    ...
                    <ul className="space-y-3">
                        <li className="flex justify-between border-b border-slate-100 pb-2">
                            <span className="font-medium">Total de Testes Realizados:</span>
                            <span className="font-bold">{totalTestes}</span>
                        </li>
                        <li className="flex justify-between border-b border-slate-100 pb-2">
                            <span className="font-medium">Testes com Veredito "Aprovado":</span>
                            <span className="font-bold text-emerald-600">{testesAprovados}</span>
                        </li>
                        <li className="flex justify-between border-b border-slate-100 pb-2">
                            <span className="font-medium">Testes com Veredito "Reprovado":</span>
                            <span className="font-bold text-red-600">{testesReprovados}</span>
                        </li>
                        <li className="flex justify-between border-b border-slate-100 pb-2">
                            <span className="font-medium">Taxa de Aprovação Geral:</span>
